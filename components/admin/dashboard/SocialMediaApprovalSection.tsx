...
interface SocialMediaApprovalSectionProps {
  pendingSocialMedia: PendingSocialMediaItem[];
  onOpenReviewDialog: (item: PendingSocialMediaItem) => void;
}

export function SocialMediaApprovalSection({
  pendingSocialMedia,
  onOpenReviewDialog,
}: SocialMediaApprovalSectionProps) {
    ...
    <>
      ...
      <Card className="flex flex-col md:hidden">
        <CardHeader className="flex flex-row items-center justify-between pb-3">
          <div>
            <CardTitle className="text-base">Social Media Approvals</CardTitle>
          </div>

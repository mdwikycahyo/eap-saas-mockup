...
import { AlertCircle, ArrowLeft, ChevronDown, Check } from "lucide-react"
...
export default function AddUserPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <AddUserForm onSubmit={handleAddUser} onCancel={handleCancel} companies={mockCompanies} />
    </div>
  )
}

function AddUserForm({ onSubmit, onCancel, companies, initialData = null }) {

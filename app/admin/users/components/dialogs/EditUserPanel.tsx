...
export function EditUserPanel({ isOpen, onClose, user, onUserUpdated }: EditUserPanelProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Update details for {user.fullName}</p>
        ...
        <div className="flex-1 p-6 space-y-6 overflow-y-auto">
          <div>
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="edit-fullName" className="text-base text-muted-foreground">
              ...
              <div>
                <Label htmlFor="edit-email" className="text-base text-muted-foreground">
              ...
              <div>
                <Label htmlFor="edit-phoneNumber" className="text-base text-muted-foreground">
                  Phone Number
                </Label>
                <Input
                  id="edit-phoneNumber"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="edit-province" className="text-base text-muted-foreground">
                ...
                <div>
                  <Label htmlFor="edit-city" className="text-base text-muted-foreground">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="edit-role-select" className="text-base text-muted-foreground">
                    Role <span className="text-red-500">*</span>
                  </Label>
                  <Select value={role} onValueChange={(value: "Creator" | "Admin") => setRole(value)}>
                    <SelectTrigger id="edit-role-select" className="mt-2">
                ...
                <div>
                  <Label htmlFor="edit-invitationStatus" className="text-base text-muted-foreground">
                  ...
                  >
                    <SelectTrigger id="edit-invitationStatus" className="mt-2">
